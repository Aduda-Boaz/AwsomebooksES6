...
var _addbooks = _interopRequireDefault(require("./addbooks.js"));
...
var _luxon = luxon,
    DateTime = _luxon.DateTime; //  eslint-disable-line
...
(0, _localstorage.getFromLocalStorage)();
form.addEventListener('submit', function (event) {
  event.preventDefault();
  var newBook = new _bookClass["default"](title.value, author.value);
  title.value = '';
  author.value = '';
